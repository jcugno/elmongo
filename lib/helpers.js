 ...
 * @return {Object}
 */
exports.serializeModel = function (model, indexedFields) {

    var serializedForm = {};
    indexedFields = indexedFields || [];

    // strip mongoose-added functions, and depopulate any populated model reference
    var deflated = model.toObject({ depopulate: true });
    var temp = exports.serialize(deflated);
    if(indexedFields.length > 0){
      indexedFields.forEach(function(field){
        serializedForm[field] = temp[field];
      });
    }else{
      serializedForm = temp;
    }
...
exports.mergeSearchBody = function (searchOpts) {
    ...
    if (searchOpts.where && Object.keys(searchOpts.where).length) {
        ...
        whereClauseKeys.forEach(function (whereClauseKey) {
            ...
            if (whereClauseKey === 'or') {
                ...
                if (Array.isArray(whereClauseValue)) {
                    ...
                    termFilters.terms[whereClauseKey] = whereClauseValue;
        ...
        if (Object.keys(termFilters.terms).length) {
          // body.query.filter.or = [ {'type' : '52966c0175dfa89880000004'}, {'type': '52966c3a75dfa89880000005'}];
          body.query.filtered.filter.terms = {'type' : ['52966c0175dfa89880000004', '52966c3a75dfa89880000005']};
         // body.constant_score.filter.or = termFilters.terms;
...
exports.doSearchAndNormalizeResults = function (searchUri, searchOpts, cb) {
    ...
    exports.backOffRequest(reqOpts, function (err, res, body) {
        ...
        if (body.facets) {
          searchResults.facets = body.facets;
        }
