...
exports.mergeSearchBody = function (searchOpts) {
    ...
    if (searchOpts.where && Object.keys(searchOpts.where).length) {
        ...
        whereClauseKeys.forEach(function (whereClauseKey) {
            ...
            if (whereClauseKey === 'or') {
                ...
                if (Array.isArray(whereClauseValue)) {
                    ...
                    termFilters[whereClauseKey] = whereClauseValue;
        ...
        var termFiltersKeys = Object.keys(termFilters);
        if (termFiltersKeys.length) {

          if (termFiltersKeys.length > 1) {
            ...
            termFiltersKeys.forEach(function(termKey) {
              var obj = {terms : {}};
              obj.terms[termKey] = termFilters[termKey];
              body.query.filtered.filter.and.filters.push(obj);
            });
